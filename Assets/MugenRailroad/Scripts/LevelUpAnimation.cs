...
public class LevelUpAnimation : MonoBehaviour
{
    ...
    public Text levelUpText;   // Texto a mostrar durante la animación
    ...
    private IEnumerator AnimateLevelUp()
    {
        ...
        levelUpText.transform.localScale = Vector3.one * 1.2f;

        // Fade in + scale
        levelUpFrame.CrossFadeAlpha(1f, fadeDuration, false);
        levelUpText.CrossFadeAlpha(1f, fadeDuration, false);
